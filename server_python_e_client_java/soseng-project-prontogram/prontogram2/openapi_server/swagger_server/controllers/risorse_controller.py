...
from swagger_server.models.inline_response200_data import InlineResponse200Data, InlineResponse200Message, InlineResponse200Links1  # noqa: E501
...
def post_createmessage(token_info=None, body=None):  # noqa: E501
    ...
    msg = {
        ...
        "data": {
            "offer": OfferMessage(body["data"]["offer"]["code"], body["data"]["offer"]["description"] ), 
        ...
        "link": {
            ...
            "self_rcv": f"/{body['data']['receiver']}/{id_rcv}", 
            "prev_rcv": f"/{body['data']['receiver']}/{prev_rcv}", 
            "next_rcv": f"/{body['data']['receiver']}/{id_rcv}"
        }
    }
