...
package io.swagger.prontogramprovider.prontogram_client;

import io.swagger.prontogramprovider.ApiCallback;
import io.swagger.prontogramprovider.ApiClient;
import io.swagger.prontogramprovider.ApiException;
import io.swagger.prontogramprovider.ApiResponse;
import io.swagger.prontogramprovider.Configuration;
import io.swagger.prontogramprovider.Pair;
import io.swagger.prontogramprovider.ProgressRequestBody;
import io.swagger.prontogramprovider.ProgressResponseBody;
...
public class RisorseApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postCreatemessageCall(InlineObject body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postCreatemessageValidateBeforeCall(InlineObject body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postCreatemessage(InlineObject body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postCreatemessageWithHttpInfo(InlineObject body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postCreatemessageAsync(InlineObject body, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postLoginCall(MapsV1Credentials body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postLoginValidateBeforeCall(MapsV1Credentials body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postLoginCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2003 postLogin(MapsV1Credentials body) throws ApiException {
        ApiResponse<InlineResponse2003> resp = postLoginWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2003> postLoginWithHttpInfo(MapsV1Credentials body) throws ApiException {
        com.squareup.okhttp.Call call = postLoginValidateBeforeCall(body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postLoginAsync(MapsV1Credentials body, final ApiCallback<InlineResponse2003> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postLoginValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2003>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
