	...
	public static void service(DelegateExecution execution) {
		...
		if (execution.getVariable("customInterest") != null) {
			execution.getProcessEngine().getRuntimeService().createMessageCorrelation("GetInterests")
				...
				.setVariable("departure_time_min", sdt.format(execution.getVariable("firstDate"))) 
				.setVariable("departure_time_max", sdt.format(execution.getVariable("secondDateInterval")))
				.setVariable("arrival_time_min", sdt.format(execution.getVariable("firstDate")))
				.setVariable("arrival_time_max", sdt.format(execution.getVariable("secondDateInterval")))
